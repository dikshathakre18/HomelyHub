//Redux toolkit is  a tool that helps us to manage and share data across different components of React easily
//User action will call all the backend apis that we had created
